...
class Order_details_bottom_bar extends StatefulWidget {
  ...
  int? orderID;
  int? statusCode;
   Order_details_bottom_bar({Key? key,required this.statusCode,required this.orderID,this.subTotal ,this.deliveryFee,this.total })
       : super(key: key);
...
class _Order_details_bottom_barState extends State<Order_details_bottom_bar> {
  ...
  Widget build(BuildContext context) {
     final   orderDetailsController = Get.put(OrderDetailsController(widget.orderID));
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(Get.find<GlobalController>()
                      .currency! +widget.subTotal.toString(),
                    style: TextStyle(
                      fontSize: 16,
                       )
                    ,),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(Get.find<GlobalController>().currency! +widget.deliveryFee.toString(),
                         style: TextStyle(
                                fontSize: 16,
                             ),
                            ),
             ...
             Expanded(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    Text(Get.find<GlobalController>().currency! +widget.total.toString(),
                        style: TextStyle(
                        fontSize: 16,
                         ),
                       ),
           ...
           ElevatedButton(
             ...
             onPressed: () async {
               setState(() {
                 ...
                 showAlertDialog(context,orderDetailsController):showAlertCompletDialog(context,orderDetailsController);
               });
             },
             child: Text(
