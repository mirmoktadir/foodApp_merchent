          ...
          child: Row(
            children: [
              Shimmer.fromColors(baseColor: Colors.grey[300]!,
                  highlightColor: Colors.grey[400]!,child: Icon(Icons.person_pin)),
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Shimmer.fromColors(baseColor: Colors.grey[300]!,
                      highlightColor: Colors.grey[400]!,child: IconButton(onPressed: (){}, icon:Icon(Icons.person_pin))),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Shimmer.fromColors(baseColor: Colors.grey[300]!,
                      highlightColor: Colors.grey[400]!,child: IconButton(onPressed: (){}, icon:Icon(Icons.location_on_outlined))),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Shimmer.fromColors(
                    baseColor: Colors.grey[300]!,
                    highlightColor: Colors.grey[400]!,
                    child: Text('017165416516',
                      style: TextStyle(
                        color: Colors.transparent,
                      ),),
                  ),
                  Shimmer.fromColors(baseColor: Colors.grey[300]!,
                      highlightColor: Colors.grey[400]!,child: IconButton(onPressed: (){}, icon:Icon(Icons.phone_sharp))),
                ],
              ),
            ],
          ),
